        ...
        <div class="wrapper-fluid wrapper-navbar sticky-navbar" id="wrapper-navbar" >
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container" >
                    ...
                    <a href="https://brahmsonline.acdh-dev.oeaw.ac.at" class="navbar-brand custom-logo-link" rel="home" itemprop="url"><img src="{$project_logo}" class="img-fluid" title="{$project_short_title}" alt="{$project_short_title}" itemprop="logo" /></a><!-- end custom logo -->
